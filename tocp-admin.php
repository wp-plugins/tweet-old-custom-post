...
function tocp_admin() {
    ...
    <?php
      /*and don\'t forget to <a href="http://wordpress.org/support/view/plugin-reviews/tweet-old-post">leave a review</a>*/
        print('
			<div class="wrap">
				<h2>' . 'Tweet Old <em>Custom Post</em> by - ' . ' Dejan Markovic - <a href="http://www.nytogroup.com/tweet-old-custom-post/">NYTO Group.com</a></h2>
...
<h3>Do you want the free version supported ? Then <a href="https://twitter.com/intent/tweet?text=Check-out%20this%20awesome%20plugin%20-%20&url=http%3A%2F%2Fwww.nytogroup.com%2Ftweet-old-custom-post%2F&via=nytogroup">show your love</a> on Twitter!</h3>
<br /><br />
...
function tocp_opt_head_admin() {
    ...
    //echo $home;
    $base = '/' . end(explode('/', str_replace(array('\\', '/tocp-admin.php'), array('/', ''), __FILE__)));
