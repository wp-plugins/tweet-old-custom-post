...
define('Tocp_OAUTH_CONSUMER_KEY', 'ofaYongByVpa3NDEbXa2g');
...
class TOPOAuth {
    ...
    function set_defeault_oauth_tokens() {
        $this->oauth_consumer_key = Tocp_OAUTH_CONSUMER_KEY;
    ...
    function get_request_token() {
       ...
       // echo ("top ouath tocp_opt_admin_url  305 " . $admin_url);
        $admin_url = get_option('tocp_opt_admin_url');
     //   echo("top oauth  admin_url 1: " .  $admin_url . "<br />");
        if (empty($admin_url)) {
       //     echo("empty" . "<br />");
            $admin_url = tocp_currentPageURL();
        }
       // echo("top oauth  admin_url 2: " .  $admin_url . "<br />");


        Tocp_DEBUG( 'In function get_request_token' );
        $params['oauth_consumer_key'] = Tocp_OAUTH_CONSUMER_KEY;
        $params['oauth_callback'] = 'http://' . $_SERVER['HTTP_HOST'] . $_SERVER['REQUEST_URI'] . '&Tocp_oauth=1';
      //  echo("params['oauth_callback'] 1" .  $params['oauth_callback'] . "<br />");
      //  $params['oauth_callback'] = htmlentities($admin_url . '&Tocp_oauth=1');
       // echo("params['oauth_callback'] 2" .  $params['oauth_callback'] . "<br />");
        //die;
